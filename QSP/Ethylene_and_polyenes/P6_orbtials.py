from QSP.Ethylene_and_polyenes.P5_orbtials import orbital_range
...
#HOMO: 43
#LUMO: 44
#orbital_range = [38,39,40,41,42,43,44,45,47,54,57,58]
orbital_range = [55,56,57,58,59]
for orb in orbital_range:
    cubegen.orbital(mol, f'/Users/admin/PycharmProjects/pyQCTools/QSP/Ethylene_and_polyenes/p6_mo{orb}.cube', mf.mo_coeff[:,orb-1], nx=80, ny=80, nz=80)
...
#pi11*:: 57
#pi12*:: 58
pi_active_pace = [38,39,40,41,42,43,44,45,47,54,57,58] #only pi and pi*
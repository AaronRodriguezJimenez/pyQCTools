...
# The following have been taken and in some cases resemble modified versions of
...
def hubbard_2d_tensors(Nx, Ny, t, U, periodic_y=False):
    ...
    #MOs = mf.mo_coeff
    mo_one = of.general_basis_change(h1, mf.mo_coeff, (1, 0))
    mo_eri = of.general_basis_change(h2, mf.mo_coeff, (1, 0, 1, 0))
    mo_eri = mo_eri.transpose(0, 2, 3, 1)

    H1, H2 = of.ops.representations.get_tensors_from_integrals(mo_one, mo_eri)
    return H1, H2

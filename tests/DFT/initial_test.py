...
"""
 Water Molecule
 The following is a simple example which runs a restricted, closed-shell KS-DFT calculation
 with the default LDA functional.
"""
mol =  gto.M(atom = '''
                O  0.   0.       0.
                H  0.   -0.757   0.587
...
mf = mf.newton()
print("Result using LDA-VWN:")
mf.kernel()

print("Total orbitals are: ", len(mf.mo_coeff))
...
#mf.verbose = 4
print("Result using a fictious GGA XC functional:")
mf.kernel()
...
#mf.verbose = 4
print("Result using a MGGA fictious functional: ")
mf.kernel()
...
mol = gto.M(atom='N 0 0 0; N 0 0 2.4000', basis='sto3g')
mf = scf.RHF(mol).run()
...
def stable_opt_internal(mf):
    ...
    return mf
print('loop example')
mol = gto.M(atom='N 0 0 0; N 0 0 2.4', basis='sto3g')
#mol.symmetry = 'D2h'
mf2 = scf.RHF(mol)
mf2.max_cycle = 100
mf2.conv_tol = 1e-8
...
#
print("Some cases need tight tolerance to give the stability correctly")
#
from pyscf.scf.stability import uhf_internal
mol = gto.M(atom='''
N          0.00000  0.00000  -1.20000
N          0.00000  0.00000   1.20000''',
basis = 'sto3g', spin=0)
mf = mol.UHF().run()
